...
\todo{'Dennoch weist sie eine ca. 80-jährige Empirieabstinenz auf.' würde ich umformulieren, etwa so: 'Dennoch wurde ca. 80 Jahre lang keine empirische Studie zu ihren Auswirkungen durchgeführt.' 'Empirieabstinenz' hört sich komisch an :)}
...
An was kann es liegen, dass es so wenige empirische Studien zur Waldorfpädagogik gibt? \cite[S. 127f]{paschen10} nennt dafür folgende ausschlaggebende Gründe:
    ...
    \todo{'unhinterfragbar' hört sich komisch an, besser wäre nicht hinterfragbar. Hmm, 'hinterfragbar' hört sich eigentlich auch komisch an.}
...
\todo{Oft (oder immer?) schreibst du einen Satz mit Punkt am Ende, dann die Literaturangabe mit Vgl...\\z.B. so: ...Universitäten vorgestellt und diskutiert.  \citep[Vgl.][S. 128]{paschen10}\\Macht man das nicht eher so:\\ ... Universitäten vorgestellt und diskutiert, \citep[vgl.][S. 128]{paschen10}.\\ Also mit Komma am Ende des Satzes und dann das vgl. ...\\wobei das vgl. auch außerhalb der eckigen Klammern ist.}
...
\todo{Du wechselst beim Sprechen über die Studie zwischen Präsenz und Vergangenheit.}
...
Oft ist diese noch stärker, als es der Alltag gestattet, sie auszuführen. \todo{Verstehe den vorangehenden Satz nicht}
